	...
	<div class="container pt-5 pb-5">
		<div class="row">
			<div class="col-sm-6">
				<div class="row wow rotateInUpLeft " data-wow-delay=".30s">
					<div class="col-sm-4 ">
						<div class="detial-design"> <img src="<?=base_url()?>assets/images/icon/detail1-white.jpg" alt="Responsive Site for All Devices"> </div>
					</div>
					<div class="col-sm-8">
			...
			<div class="col-sm-6">
				<div class="row wow rotateInUpRight " data-wow-delay=".30s">
					<div class="col-sm-4">
						<div class="detial-design"> <img src="<?=base_url()?>assets/images/icon/detail2-white.jpg" alt="Responsive Website Design all devices" > </div>
					</div>
					<div class="col-sm-8">
		...
		<div class="row">
			<div class="col-sm-6">
				<div class="row wow rotateInUpLeft " data-wow-delay=".40s">
					<div class="col-sm-4">
						<div class="detial-design"> <img src="<?=base_url()?>assets/images/icon/detail3-white.jpg"  alt="Responsive Website Design all devices" > </div>
					</div>
					<div class="col-sm-8">
			...
			<div class="col-sm-6">
				<div class="row wow rotateInUpRight " data-wow-delay=".40s">
					<div class="col-sm-4">
						<div class="detial-design"> <img src="<?=base_url()?>assets/images/icon/detail4-white.jpg"  alt="online Responsive Website Design" > </div>
					</div>
					<div class="col-sm-8">
		...
		<div class="row">
			<div class="col-sm-6">
				<div class="row  wow rotateInUpLeft " data-wow-delay=".30s">
					<div class="col-sm-4">
						<div class="detial-design"> <img src="<?=base_url()?>assets/images/icon/detail5-white.jpg"  alt="Responsive Website Design company "> </div>
					</div>
					<div class="col-sm-8">
...
// Add active class to the current button (highlight it)  
 $('.listitem').click(function(e) {           e.preventDefault();           $('.listitem').removeClass('active');           $(this).addClass('active');       });                    $(window).scroll(function(){     var sticky = $('.seo-mockup-mg'),         scroll = $(window).scrollTop();      if (scroll >= 2000 ) sticky.addClass('active-seo');     else sticky.removeClass('active-seo');            });               var words = ['Responsive Website Design Agency.', 'Web Responsive to your site.'],       part,       i = 0,       offset = 0,       len = words.length,       forwards = true,       skip_count = 0,       skip_delay = 15,       speed = 70;   var wordflick = function () {     setInterval(function () {       if (forwards) {         if (offset >= words[i].length) {           ++skip_count;           if (skip_count == skip_delay) {             forwards = false;             skip_count = 0;           }         }       }       else {         if (offset == 0) {           forwards = true;           i++;           offset = 0;           if (i >= len) {             i = 0;           }         }       }       part = words[i].substr(0, offset);       if (skip_count == 0) {         if (forwards) {           offset++;         }         else {           offset--;         }       }       $('.wordH').text(part);     },speed);   };      $(document).ready(function () {     wordflick();   });
</script>