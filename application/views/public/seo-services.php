      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-sm-6 text-center">
            <div class="ecom-img-section"> <img src="<?= base_url('assets/images/20-1.gif')?>" alt="Seo Services in delhi" class="text-center pull-right banner-img"> </div>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="container">
    ...
    <div class="row BannerOpenGraph101">
      ...
      <div class="col-sm-3 bounce-1 wow fadeInUp " data-wow-delay=".35s">
        <div class="graf-column-wrap">
          <div class="widget-wrap text-center">
            <div class="widget-container"> <img src="<?=base_url()?>assets/images/slider/agency-Research-icon.png" alt="Research & Analysis"/> </div>
      ...
      <div class="col-sm-3 bounce-1 wow fadeInUp " data-wow-delay=".55s">
        <div class="graf-column-wrap">
          <div class="widget-wrap text-center">
            <div class="widget-container"> <img src="<?=base_url()?>assets/images/slider/agency-Lable-icon.png" alt="Grow Business"/> </div>
    ...
    <div class="row BannerOpenGraph101">
      ...
      <div class=" col-sm-6 ">
        <div class="title_lead pl-4 pr-4" data-wow-delay=".20s">
          ...
          <h2 class="text-left  text-left wow fadeInUp " data-wow-delay=".20s">Exceptional Web Solution For An Online Business Model </h2>
          <p class="text-left wow fadeInUp  " data-wow-delay=".25s"> Hiring an SEO expert could well prove to be a shot in the arm for your online business, that deserves a robust web presence.</p>
          <ul class="content-desc">
            <li class="text-dark wow fadeInRight" data-wow-delay=".25s"><img src="<?=base_url()?>assets/images/icon/agency-check.png" alt="Get Started With A Dynamic Web Optimization" class="opacity-1"><b>Get Started With A Dynamic Web Optimization</b></li>
            <li class="text-dark wow fadeInRight" data-wow-delay=".35s"><img src="<?=base_url()?>assets/images/icon/agency-check.png" alt="UVO Content Marketing Service" class="opacity-1"><b>UVO Content Marketing Service</b></li>
            <li class="text-dark wow fadeInRight" data-wow-delay=".45s"><img src="<?=base_url()?>assets/images/icon/agency-check.png" alt="Marketing Strategy & SEO Campaigns" class="opacity-1"><b>Marketing Strategy & SEO Campaigns</b></li>
            <li class="text-dark wow fadeInRight" data-wow-delay=".55s"><img src="<?=base_url()?>assets/images/icon/agency-check.png" alt="Video/photo gallery" class="opacity-1"><b>Video/photo gallery</b></li>
            <li class="text-dark wow fadeInRight" data-wow-delay=".65s"><img src="<?=base_url()?>assets/images/icon/agency-check.png" alt="Campaign For Your Niche." class="opacity-1"><b>Campaign For Your Niche.</b></li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class=" col-sm-12 ">
        <div class="title_lead pl-4 pr-4" data-wow-delay=".20s">
          ...
          <p class="text-left  text-white wow fadeInUp  " data-wow-delay=".25s">Hiring an SEO expert could well prove to be a shot in the arm for your online business, that deserves a robust web presence.</p>
          <h3 class="text-left  text-white wow fadeInUp  " data-wow-delay=".25s"><strong>Get Started With a Dynamic Web Optimization Campaign for Your Niche.</strong></h3> </div>
      </div>
    </div>
  </div>
</section>
...
<script>
var words = ['WelCome To Megatask Technologies Pvt Ltd SEO .', 'An SEO Marketing Agency Increase Brand Awareness.', 'Drive traffic to your site.'],
  part,
  i = 0,
  offset = 0,
  len = words.length,
