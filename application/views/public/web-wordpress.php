		...
		<div class="container-fluid   ">
			<div class="container">
				<div class="row  pt-3 pb-3  ">
					...
					<div class="col-sm-6 ecom-img-section text-center mt-5"> <img src="<?= base_url()?>assets/images/word.png" Alt="Wordpress development in delhi" class="Website Redesign ml-5"> </div>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="row BannerOpenGraph101">
			<div class=" col-sm-6">
				<div class="title_lead wow fadeInUp bounceLeft-101 " data-wow-delay=".20s">
					<div class="something-imagin-bg " > <img src="<?= base_url('assets/images/word1.png')?>" class="text-center" alt="Creative Web Designer - Delhi Web Designer"> </div>
				</div>
			</div>
			<div class=" col-sm-6 ">
				<div class="title_lead mb-5 ml-5" data-wow-delay=".20s">
					<h1 class="text-dark  text-left wow bounceInRight" data-wow-delay=".40s">Creative Wordpress Designer - Delhi WordpressDesigner</h1>
				...
				<div class="contactExperts wow rotateInUpLeft" data-wow-delay=".40s">
					<div class="images "> <span>                  
						<img class="rounded-circle text-left ml-5" width="50" height="50"  src="<?=base_url()?>assets/images/Oval-Copy-17.jpg"  alt="Wordpress development agency in delhi">
						</span>
						<span>
						<img  class="rounded-circle" width="50" height="50"  src="<?=base_url()?>assets/images/Oval-Copy-59.jpg"   alt="Wordpress development in noida" >
						</span>
						<span>
						<img  class="rounded-circle" width="50" height="50" src="<?=base_url()?>assets/images/Oval-Copy-30.jpg"   alt="Wordpress development agency in noida" >
						</span>
						</div>
		...
		<div class="row BannerOpenGraph101">
			<div class=" col-sm-6 ">
				<div class="title_lead pl-4 pr-4">
					...
					<h3 class="text-left wow bounceInLeft  " data-wow-delay=".25s">Other WordPress Plugins That Should Interest You Web Designing ?</h3>
					<p class="text-justify wow bounceInLeft  " data-wow-delay=".30s">There are plenty of styling options available, as you can see in the screenshots below. Choose the size, weight, color, decoration, and styles to customize your unique Table of Contents.First on our list is the CM Table of Contents from our very own team of expert WordPress developers .</p> <a href="<?php echo base_url()?>contact-us" class="btn btn-outline-success text-dark my-2 my-sm-0 get_quote   wow bounceInLeft " data-wow-delay=".50s" type="submit">Contact Us</a> </div>
			</div>
			<div class=" col-sm-6  bounceLeft-101 " data-wow-delay=".30s">
				<div class="title_lead wow fadeInUp " data-wow-delay=".20s">
					<div class="fly-image">
						<p class="text-center  "> <img src="<?=base_url()?>assets/images/ftp.png" class="bounce-1" alt="Website Designing" /> </p>
					</div>
				</div>
			</div>
		</div>
...
<section class="mt-3 mb-3 pt-5 pb-5 implement-seo">
	...
	<div class="container bg-dark pt-5 pb-5 border-rounded">
		<div class="row">
			<div class=" col-sm-6">
				<div class="mac-img-container ZoomIn-101 "> <img src="<?=base_url()?>assets/images/mac.png" alt="online Wordpress development agency in noida" > </div>
			</div>
					...
					<div class="row">
							...
							<div class="inner-container-tag bg-theme-red">
								<div class="widget-wrap">
									<div class="image-box-wrapper">
										<div class="image-box-img"> <img src="<?php base_url()?>assets/images/icon/icon1.svg"  alt="online Wordpress development agency in delhi"  class="opacity-1"> </div>
						...
						<div class="col-sm-6  pl-0 pr-0 wow rotateIn " data-wow-delay=".25s">
							<div class="inner-container-tag bg-theme-white">
								<div class="widget-wrap">
									<div class="image-box-wrapper">
										<div class="image-box-img"> <img src="<?php base_url()?>assets/images/icon/icon2.svg" class="opacity-1" alt="online Wordpress development agency in delhi" > </div>
										<div class="image-box-content">
					...
					<div class="row">
						<div class="col-sm-6  pl-0 pr-0 wow rotateIn " data-wow-delay=".30s">
							<div class="inner-container-tag bg-theme-white">
								<div class="widget-wrap">
									<div class="image-box-wrapper">
										<div class="image-box-img"> <img src="<?php base_url()?>assets/images/icon/icon3.svg" class="opacity-1" alt="Wordpress development agency in india" > </div>
										<div class="image-box-content">
						...
						<div class="col-sm-6  pl-0 pr-0 wow rotateIn " data-wow-delay=".35s">
							<div class="inner-container-tag bg-theme-white">
								<div class="widget-wrap">
									<div class="image-box-wrapper">
										<div class="image-box-img"> <img src="<?php base_url()?>assets/images/icon/icon2.svg" alt="Wordpress development agency in delhi"  class="opacity-1"> </div>
										<div class="image-box-content">
...
<section class="pt-5 pb-5 website-design-contain bg-info">
	<div class="container">
		<div class="row BannerOpenGraph101">
			<div class=" col-sm-6 ">
...
var words = ['WordPress Development Services for Your Website Responsive easily navigate your website'],
   part,
   i = 0,
   offset = 0,
   len = words.length,
